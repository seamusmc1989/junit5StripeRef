package com.ref.testing.payment.stripe;

import com.ref.testing.payment.CardPaymentCharge;
import com.ref.testing.payment.CardPaymentCharger;
import com.ref.testing.payment.Currency;
...
public class StripeService implements CardPaymentCharger {
    ...
    private final static RequestOptions requestOptions = RequestOptions.builder()
            .setApiKey("sk_test_51GrnJ3B27UUQWpngNFaHyXQccqBGuiHB6cb4aWK4Gzdj7tL2FdqEhIEZNASR5z61KakuPOmj4rUi3ZuBFEtZqOOg00wtsuoQmb")
            .build();
